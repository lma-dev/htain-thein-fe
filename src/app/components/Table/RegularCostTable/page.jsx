...
const RegularCostTable = ({ data, fetchData, loading, tableHeight }) => {
    return (
        <div className="flex flex-col w-full">
            <div className="p-1.5 min-w-full inline-block align-middle">
                <div className={`border rounded-lg shadow dark:border-gray-700 dark:shadow-gray-900 overflow-auto ${tableHeight ? tableHeight : 'h-full'}`}>
                    <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700 ">
                        ...
                        <tbody className="divide-y divide-gray-200 dark:divide-gray-700 relative">
                            {loading ? (
                                <>
                                    <SkeletonTableRow cellWidths={['16', '24', '20', '32', '28', '8']} />
                                    <SkeletonTableRow cellWidths={['16', '24', '20', '32', '28', '8']} />
                                    <SkeletonTableRow cellWidths={['16', '24', '20', '32', '28', '8']} />
                                    <SkeletonTableRow cellWidths={['16', '24', '20', '32', '28', '8']} />
                                    <SkeletonTableRow cellWidths={['16', '24', '20', '32', '28', '8']} />
