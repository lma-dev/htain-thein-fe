...
const ReportTable = ({ data, fetchReports }) => {
    return (
                    ...
                    <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700  ">
                        <thead className="bg-gray-50 dark:bg-gray-700">
                            <tr>
                                ...
                                <th scope="col" className="px-6 py-3 text-start text-xs font-bold text-gray-700 uppercase dark:text-gray-400">Verifier</th>
                        ...
                        <tbody className="divide-y divide-gray-200 dark:divide-gray-700 relative">
                            {data.map((item, index) => (
                                <tr key={index}>
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600 dark:text-gray-200">{item.verifier?.name ?? ""}
                                    </td>
